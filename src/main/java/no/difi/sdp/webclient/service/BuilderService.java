...
public class BuilderService {
    ...
    private KonvoluttAdresse buildAdresse(no.difi.sdp.webclient.domain.KonvoluttAdresse adresseFrom) {
        KonvoluttAdresse adresseTo = null;
        if (adresseFrom.getType() == no.difi.sdp.webclient.domain.KonvoluttAdresse.Type.NORSK) {
        ...
        } else if (adresseFrom.getType() == no.difi.sdp.webclient.domain.KonvoluttAdresse.Type.UTENLANDSK) {
            adresseTo = adresseTo.build(adresseFrom.getNavn())
