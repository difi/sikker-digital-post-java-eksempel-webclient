...
public interface MessageRepository extends JpaRepository<Message, Long>{
	...
	@Query("select distinct m.keyPairAlias from Message m where m.status=no.difi.sdp.testavsender.domain.MessageStatus.WAITING_FOR_RECEIPT or m.status=no.difi.sdp.testavsender.domain.MessageStatus.WAITING_FOR_OPENED_RECEIPT or m.status=no.difi.sdp.testavsender.domain.MessageStatus.WAITING_FOR_DELIVERED_RECEIPT")
